...
function animate() {
  ...
  tl.set(['#bottomPanel2'], {force3D: true })
  tl.set(['#main_content'], {y:"+=453", autoAlpha: 0, force3D: true })
  tl.set(['#h4', '#priceHolder', '#cta', '#terms_container'], {autoAlpha: 0, force3D: true })
  .set(["#cta"], { force3D: true, rotation: .001 })
    ...
    .to('#bottomPanel2', 0.5, {autoAlpha: 1, ease: Power1.easeInOut }) 
    .to(['#h4', '#priceHolder', '#cta', '#terms_container, #main_content'], 0.1, {delay: 0.5, autoAlpha: 1, force3D: true }) 
    .to('#main_content', 1.1, { y:"-=453", ease: Back.easeOut.config(.3)})
